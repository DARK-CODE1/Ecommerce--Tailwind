            ...
            <div className="container">
                <div style={{ backgroundColor: data.bgColor }} className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white  rounded-3xl'>
                    ...
                    <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
                        ...
                        <h1 data-aos='fade-up' className="text-3xl sm:text-5xl font-bold">{data.title3}</h1>
                        <p data-aos='fade-up' className="text-sm tracking-wide leading-5">{data.title4}</p>
                        <div>
                            <button data-aos='fade-up'  data-aos-offset='0' style={{ color: data.bgColor }} className='bg-white py-2 px-4 rounded-full'>Shop Now</button>
                        </div>
                    </div>
                </div>
            </div>
